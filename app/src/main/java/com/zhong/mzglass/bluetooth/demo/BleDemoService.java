...
public class BleDemoService extends Service {

    private final String TAG = BleDemoService.class.getSimpleName();
    ...
    // 蓝牙已连接
    public final static String ACTION_GATT_CONNECTED = "com.zhong.mzglass.bluetooth.demo.ACTION_GATT_CONNECTED";
    // 蓝牙已断开
    public final static String ACTION_GATT_DISCONNECTED = "com.zhong.mzglass.bluetooth.demo.ACTION_GATT_DISCONNECTED";
    // 发现GATT服务
    public final static String ACTION_GATT_SERVICES_DISCOVERED = "com.zhong.mzglass.bluetooth.demo.ACTION_GATT_SERVICES_DISCOVERED";
    // 收到蓝牙数据
    public final static String ACTION_DATA_AVAILABLE = "com.zhong.mzglass.bluetooth.demo.ACTION_DATA_AVAILABLE";
    // 连接失败
    public final static String ACTION_CONNECTING_FAIL = "com.zhong.mzglass.bluetooth.demo.ACTION_CONNECTING_FAIL";
    // 蓝牙数据
    public final static String EXTRA_DATA = "com.zhong.mzglass.bluetooth.demo.EXTRA_DATA";

    // 服务标识
    private final UUID SERVICE_UUID = UUID.fromString(Constants.UUID_TEST_UART_SERVICE);
    // 特征标识（读取数据）
    ...
    public class LocalBinder extends Binder {
        public BleDemoService getService() {
            return BleDemoService.this;
        }
    }
